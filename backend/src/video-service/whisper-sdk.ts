import { SpeechConfig, SpeechRecognizer, ResultReason, CancellationReason , AudioConfig } from "microsoft-cognitiveservices-speech-sdk";
...
const filename = `${uploadDirectory}/Yesterday.wav`
 ...
 const speechConfig = SpeechConfig.fromSubscription(subscriptionKey as string, serviceRegion);
